...
# 5折，k1～k5
def split_train_valid_list(K_version,is_post_train=False):
    split = 'train_5088'
...
if __name__ == '__main__':
    ...
    #post_train
    post_version = 2
    split_train_valid_list(post_version,is_post_train=True)
    check_lists_overlap(post_version,is_post_train=True)
