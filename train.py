...
def run_train():
    ...
    out_dir  = './result'  #'/root/share/project/kaggle-carvana-cars/results/single/UNet_double_1024_5'
...
#********
    ...
    test_dataset = KgCarDataset( 'test_3197',
                                  is_label=False,
                                  is_preload=False,)
...
def run_submit():
    ...
    test_dataset = KgCarDataset( 'test_100064_5',
                                  is_label=False,
    ...
    if 1:
        ...
        start = timer()
        net.eval()
        probs = predict_in_blocks( net, test_loader, block_size=20000 )           # 20 min
